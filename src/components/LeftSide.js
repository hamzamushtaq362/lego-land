...
export default function LeftSide(props) {
    ...
    function handleFilter(){
        ...
        axios.post(`http://localhost:2000/api/searchProductByPrice`, { max: range[0], min: range[1]})
        .then(res => {
        console.log(res);
        // console.log(res.data.products);
        setRangeData(res.data.products)
    })
    }
    ...
    return (
        <>
            <div className='cont2'>
                ...
                {/* c2d2 */}
                <RightSide rangeData={rangeData} ageCheck={ageCheck} cart={props.cart} getCart={props.getCart} />
            </div>
        </>
    )
}
