                        ...
                        <div className='c2logo'>
                            <div className='icon main-page'>
                                <BsBagDash style={{ fontSize: "24px", margin: "6px" }} />
                                    <span>{props.cart.length} Products - ${props.cart.reduce(function (acc, obj) { return acc + obj.product_price; }, 0)}</span>
                            </div>
                            <AiOutlineArrowRight onClick={()=>navigate("/checkout")} style={{ fontSize: "14px", marginLeft: "20%" }} />
                        </div>
                        {/* c1logo end */}
