...
import CartAddAlert from './CartAddAlert';
...
export default function RightSide(props) {
    ...
    const [pageCount, setPageCount] = useState({start: 0, end: 6});
    ...
    const handlePagination = (event, value) => {
        setPage(value);
        previousValue.current = page;
        // console.log("previousValue.current",previousValue.current);
        // console.log("page",page);
        // if (previousValue.current <= page){
        //     console.log("if");
        //     setPageCount({
        //         ...pageCount,
        //         start: pageCount.end,
        //         end: pageCount.end+6
        //     })
        // } else if (previousValue.current >= page){
        //     console.log("elsee");
        //     setPageCount({
        //         ...pageCount,
        //         start: pageCount.end-12,
        //         end: pageCount.end-6
        //     })
        // }

        // console.log(pageCount.start,pageCount.end);
        // const filtered=data.slice(pageCount.start,pageCount.end);
    ...
    useEffect(()=>{
        ...
        console.log("agecheck props",props.ageCheck);
        setData(props.rangeData);
      },[props.rangeData])
  ...
  return (
    <>
      <div className='c2d2'>
        {/* <CartAddAlert /> */}
        {
            console.log(previousValue.current,page)
        }
        {/* <PaginationControlled page={page} handlePagination={handlePagination} /> */}
                        ...
                        <div className='search-cont'>
                            ...
                            <div style={{
                                ...
                                </select>
                                {
                                    ...
                                    // console.log("range props",props.rangeData)
                                }
                            </div>
                        </div>
